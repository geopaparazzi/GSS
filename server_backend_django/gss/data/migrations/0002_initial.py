    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subdomains', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['label'], name='data_wmssou_label_affa17_idx'),
        ),
        migrations.AddField(
            model_name='userdeviceassociation',
            name='device',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='data.device'),
        ),
        migrations.AddField(
            model_name='userdeviceassociation',
            name='user',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['label'], name='data_tmssou_label_1b66f1_idx'),
        ),
        migrations.AddIndex(
            model_name='projectdata',
            index=models.Index(fields=['label'], name='data_projec_label_5a0714_idx'),
        ),
        migrations.AddField(
            model_name='project',
            name='groups',
        ...
        migrations.AddField(
            model_name='project',
            name='projectdata',
            field=models.ManyToManyField(blank=True, to='data.projectdata'),
        ),
        migrations.AddField(
            model_name='project',
            name='tmssources',
            field=models.ManyToManyField(blank=True, to='data.tmssource'),
        ),
        migrations.AddField(
            model_name='project',
            name='wmssources',
            field=models.ManyToManyField(blank=True, to='data.wmssource'),
        ),
        migrations.AddField(
            model_name='note',
            name='previous',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='data.note'),
        ),
        migrations.AddField(
            model_name='note',
            name='project',
        ...
        migrations.AddField(
            model_name='image',
            name='imagedata',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='data.imagedata'),
        ),
        migrations.AddField(
            model_name='image',
            name='notes',
        ...
        migrations.AddField(
            ...
            name='gpslogid',
            field=models.ForeignKey(default=-1, on_delete=django.db.models.deletion.CASCADE, to='data.gpslog'),
        ),
        migrations.AddField(
            model_name='gpslog',
            name='project',
        ...
        migrations.AddIndex(
            model_name='device',
            index=models.Index(fields=['name'], name='data_device_name_c7a66d_idx'),
        ),
        migrations.AddIndex(
            model_name='device',
            index=models.Index(fields=['uniqueid'], name='data_device_uniquei_c589a7_idx'),
        ),
        migrations.AddIndex(
            model_name='userdeviceassociation',
        ...
        migrations.AddIndex(
            model_name='userconfiguration',
            index=models.Index(fields=['key'], name='data_userco_key_794a6a_idx'),
        ),
        migrations.AddIndex(
            model_name='userconfiguration',
            index=models.Index(fields=['user'], name='data_userco_user_id_ff535b_idx'),
        ),
        migrations.AddIndex(
            model_name='userconfiguration',
            index=models.Index(fields=['project'], name='data_userco_project_593960_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='userconfiguration',
            unique_together={('key', 'user', 'project')},
        ),
        migrations.AddIndex(
            model_name='project',
            index=models.Index(fields=['name'], name='data_projec_name_ee9fe0_idx'),
        ),
        migrations.AddIndex(
            model_name='note',
            index=models.Index(fields=['previous'], name='data_note_previou_b13fb3_idx'),
        ),
        migrations.AddIndex(
            model_name='note',
        ...
        migrations.AddIndex(
            model_name='lastuserposition',
            index=models.Index(fields=['ts'], name='data_lastus_ts_1c107c_idx'),
        ),
        migrations.AddIndex(
            model_name='lastuserposition',
            index=models.Index(fields=['uploadts'], name='data_lastus_uploadt_576980_idx'),
        ),
        migrations.AddIndex(
            model_name='lastuserposition',
            index=models.Index(fields=['user'], name='data_lastus_user_id_27d47f_idx'),
        ),
        migrations.AddIndex(
            model_name='lastuserposition',
            index=models.Index(fields=['project'], name='data_lastus_project_f9be3a_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='lastuserposition',
