 ...
 */
public class KukuratusPolygonType extends BaseDataType {
    private static final KukuratusPolygonType singleTon = new KukuratusPolygonType();
    private static EDb dbType;
    private static PostgisGeometryParser pg = new PostgisGeometryParser();

    public static KukuratusPolygonType getSingleton() {
        return singleTon;
    }

    private KukuratusPolygonType() {
    ...
    private static Class< ? >[] getGeomClass() {
        ...
        case H2GIS:
        default:
            return new Class< ? >[]{org.locationtech.jts.geom.Polygon.class};
        }
    }
     ...
     */
    protected KukuratusPolygonType( SqlType sqlType, Class< ? >[] classes ) {
