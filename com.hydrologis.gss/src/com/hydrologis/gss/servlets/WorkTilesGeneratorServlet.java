...
import com.gasleaksensors.databases.v2.core.objects.PipePieces;
 ...
 */
public class WorkTilesGeneratorServlet extends DbTilesGeneratorServlet {

    private static final long serialVersionUID = 1L;

    private static TreeMap<String, SpatialDbTilesGenerator> tilesGeneratorMap = new TreeMap<>();
    static final String whereStr = PipePieces.EVENTSID_FIELD_NAME + " is not null group by " + PipePieces.PARENTID_FIELD_NAME;
    static final String tableName = DatabaseHandler.getTableName(PipePieces.class);
