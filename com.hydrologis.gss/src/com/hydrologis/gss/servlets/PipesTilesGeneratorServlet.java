 ...
 */
public class PipesTilesGeneratorServlet extends DbTilesGeneratorServlet {

    private static final long serialVersionUID = 1L;

    private static TreeMap<String, SpatialDbTilesGenerator> tilesGeneratorMap = new TreeMap<>();
    static final String whereStr = null;
    static final String tableName = DatabaseHandler.getTableName(Pipes.class);
